...
- **Complication**: the `WatchAppComplication` Widget Extension target ships in both
  ...
  there showed kilometres to a runner who chose miles ([decisions § 1698](../../docs/architecture/decisions.md)).
