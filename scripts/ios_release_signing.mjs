...
// phone app, the Apple Watch app and the Live Activity widget extension it
// embeds — to manual signing against the profile whose bundle id matches, and
// leaves every other configuration alone. A target added to the project needs
// an App Store profile of its own before the next release, and the guard beside
// this file is what says so on the PR rather than on the Mac runner.
//
