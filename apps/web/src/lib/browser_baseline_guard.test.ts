...
// it was unmeasurable (decisions § 1656). It is now the first entry below,
...
const EXCEPTIONS: Exception[] = [
	{
		...
		reason: 'above-floor',
		until: { firefox: 125 },
		why: "the grapheme cut is the crawler's on every runtime the floor names except Firefox 121-124, which degrade to the code-unit cut. Every share `<head>` is built through this in the tab as well as on the Lambda, so a throw here is a blank page, not a clipped title (decisions § 1529, § 1656).",
	},
	{
