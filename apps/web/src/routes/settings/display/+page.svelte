	...
	<section class="card">
		...
		<div class="form-grid">
			...
			<label>
				...
				<select bind:value={paceFormat} onchange={() => prefs.save({ units_pace_format: paceFormat })}>
			...
			<label>
				...
				<select bind:value={weekStartDay} onchange={() => prefs.save({ week_start_day: weekStartDay })}>
