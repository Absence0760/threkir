...
### `apps/backend/supabase/functions/**/*.test.ts` — 964 deno tests across 71 files
...
### `apps/web/tests-e2e/**/*.spec.ts` — 1,803 declared tests across 479 spec files (Playwright suite)
